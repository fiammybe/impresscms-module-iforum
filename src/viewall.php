...
$xoopsOption['template_main'] = 'iforum_viewall.html.tpl';
...
{
	$nav = new icms_view_PageNav($all_topics, icms::$module->config['topics_per_page'], $start, "start", 'sortname='.$sortname.'&amp;sortorder='.$sortorder.'&amp;since='.$since."&amp;type=$type&amp;mode=".$mode);
