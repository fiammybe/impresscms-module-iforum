<?php
	...
	*/
	...
	define("_MI_VIEWMODE_DESC", "برای اینکه تنظیمات موجود در هسته ایمپرس سی‌ام‌اس در قسمت تنظیمات کلی برای نشان دادن پست‌ها بی اثر شود بر روی حالت یک صفحه ای قرار دهید، حالت شاخه ای و هیچکدام باعث می‌شود که تنظیمات موجود در هسته اعمال شوند.");
	...
	define("_MI_SUBJECT_PREFIX_DEFAULT", '<span style="color: #00CC00; ">[حل شده]</span>,<span style="color: #00CC00; ">[قطعی شده]</span>,<span style="color: #FF0000; ">[درخواست شده]</span>,<span style="color: #FF0000; ">[گزارش خطا]</span>,<span style="color: #FF0000; ">[حل نشده]</span>');
	...
	define("_MI_SPL_ANYONE", 'همه‌ی گروه‌ها');
	...
	define($constpref."_INSTALL_POST_TEXT", "
		به انجمن‌های سایت ".(htmlspecialchars(icms::$config->getConfig('sitename'), ENT_QUOTES))." خوش آمدید.<br />
