<?php
	...
	define('_MD_DEL_ONE', 'Alleen dit bericht verwijderen');
	define('_MD_DEL_RELATED', 'Verwijder alle berichten in dit onderwerp');
	define('_MD_MARK_ALL_FORUMS', 'Markeer alle fora');
	define('_MD_MARK_ALL_TOPICS', 'Markeer alle onderwerpen');
	define('_MD_MARK_UNREAD', 'ongelezen');
	define('_MD_MARK_READ', 'gelezen');
	define('_MD_ALL_FORUM_MARKED', 'Alle fora zijn gemarkeerd');
	define('_MD_ALL_TOPIC_MARKED', 'Alle onderwerpen gemarkeerd');
	define('_MD_BOARD_DISCLAIMER', 'Bord disclaimer');
	 
	 
	//index.php
	define('_MD_ADMINCP', 'Beheer scherm');
	define('_MD_FORUM', 'Forum');
	define('_MD_WELCOME', 'Welkom in %s Forum.');
	define('_MD_TOPICS', 'Onderwerpen');
	define('_MD_POSTS', 'Berichten');
	define('_MD_LASTPOST', 'Laatste bericht');
	define('_MD_MODERATOR', 'Moderator');
	define('_MD_NEWPOSTS', 'Nieuwe berichten');
	define('_MD_NONEWPOSTS', 'Geen nieuwe berichten');
	...
	define('_MD_DOXCODE', 'Enable BB Code');
	...
	define("_MD_TODAY", "	\\o\\d\\a\\y G:i:s");
	define("_MD_YESTERDAY", "\\Y\e\\s\\t\e\\r\\d\\a\\y G:i:s");
