<?php
	...
	*/
	...
	define("_MI_SUBJECT_PREFIX_DEFAULT", '<span style="color: #00CC00; ">[Resolvido]</span>,<span style="color: #00CC00; ">[Corrigido]</span>,<span style="color: #FF0000; ">[Solicitação]</span>,<span style="color: #FF0000; ">[Relato de Erro]</span>,<span style="color: #FF0000; ">[Não resolvido]</span>');
	...
	define($constpref."_INSTALL_POST_TEXT", "
		Bem-vindo para o ".(htmlspecialchars(icms::$config->getConfig('sitename'), ENT_QUOTES))." forum.
