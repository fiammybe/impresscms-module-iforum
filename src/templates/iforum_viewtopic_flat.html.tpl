...
<{include file="$iforum_template_path/iforum_right.html" topic_post=$topic_post}>
<{else}>
<{*include file="db:iforum_thread.html" topic_post=$topic_post mode=$mode*}>
<{include file="$iforum_template_path/iforum_thread.html" topic_post=$topic_post mode=$mode}>
<{/if}>
<br />
<{/foreach}>
<div class="clear"></div>
