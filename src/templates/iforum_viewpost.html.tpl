...
<{if $viewmode_compact}>
<{include file="$iforum_template_path/iforum_item.html.tpl" topic_post=$post}>
<{elseif $viewmode_left}>
<{include file="$iforum_template_path/iforum_left.html.tpl" topic_post=$post}>
<{elseif $viewmode_right}>
<{include file="$iforum_template_path/iforum_right.html.tpl" topic_post=$post}>
<{else}>
<{include file="$iforum_template_path/iforum_thread.html.tpl" topic_post=$post mode=$mode}>
<{/if}>
