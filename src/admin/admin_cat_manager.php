...
switch ($op)
{
	...
	{
		icms::$module->displayAdminMenu(1, _AM_IFORUM_CREATENEWCATEGORY);
	...
	icms::$module->displayAdminMenu(1, _AM_IFORUM_CATADMIN);
	echo "<fieldset style='border: #e8e8e8 1px solid;'>
	...
	case "mod":
	$fc =$category_handler->get($cat_id);
	icms::$module->displayAdminMenu(1, _AM_IFORUM_EDITCATEGORY . $fc->getVar('cat_title'));
	echo "<fieldset style='border: #e8e8e8 1px solid;'>
